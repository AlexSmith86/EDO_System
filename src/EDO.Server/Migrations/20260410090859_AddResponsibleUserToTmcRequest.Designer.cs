...
namespace EDO.Server.Migrations
{
    ...
    [Migration("20260410090859_AddResponsibleUserToTmcRequest")]
    partial class AddResponsibleUserToTmcRequest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EDO.Server.Models.ActionHistory", b =>
                {
                    ...
                    b.HasOne("EDO.Server.Models.WorkflowStep", "WorkflowStep")
                        .WithMany()
            ...
            modelBuilder.Entity("EDO.Server.Models.TmcRequest", b =>
                {
                    ...
                    b.HasOne("EDO.Server.Models.User", "ResponsibleUser")
                        .WithMany()
